...
class PostDetailsView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            return redirect('posts:post_details', self.post_instance.id, self.post_instance.slug)
...
class PostUpdateView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            return redirect('posts:post_details', post.id, post.slug)
...
class PostCreateView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            return redirect('posts:post_details', new_post.id, new_post.slug)
